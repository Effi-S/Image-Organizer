...
def main():
    ...
    parser.add_argument('--type', help='type of algorithm summary to check ( similar or exact)', default='exact')
    parser.add_argument('--test', help='type of test was run (rotate, crop , ... )', default='')

    args = parser.parse_args()

    workbook = xlsxwriter.Workbook('{root}/{test}_{type}_{sm}'.format(root=args.root, test=args.test, type=args.type, sm='summary.xlsx'))
    ...
    for folder in folders:
        ...
        worksheet.write(last_row, 1, '{}/{}'.format(found, last_row - 1))
